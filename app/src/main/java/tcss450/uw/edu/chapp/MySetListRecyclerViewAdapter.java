...
import tcss450.uw.edu.chapp.SetListFragment.OnListFragmentInteractionListener;
import tcss450.uw.edu.chapp.setlist.SetList;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link tcss450.uw.edu.chapp.setlist.SetList} and makes a call to the
